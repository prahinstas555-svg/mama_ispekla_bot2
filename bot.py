...
async def cmd_start(message: Message):
    text = (
        "Здравствуйте! 💙\n\n"
        "Добро пожаловать в кондитерскую-пекарню <b>«Мама Испекла»</b>!\n"
        "Здесь готовят с любовью с 2016 года 🍰\n\n"
        "Нажмите кнопку <b>«🛍 Открыть магазин»</b> внизу 👇"
    )
    # Сначала показываем нижнюю кнопку магазина
    await message.answer(text, reply_markup=shop_keyboard(), parse_mode="HTML")
    # Затем дополнительное меню
